...
impl Element {
    ...
    pub fn eval_n_dfd0(&self, n_vec : &mut [DiffDoub0], d_nds : &mut [DiffDoub0], spt : & [f64]) {
        if(self.this_type == 4 || self.this_type == 400) {
            ...
            let mut p1 : f64 =  1.0 - spt[0] - spt[1] - spt[2];
            let mut p2 : f64 =  p1 - 0.5;
    ...
    pub fn get_inst_ori_dfd0(& self, inst_ori_mat : &mut Vec<DiffDoub0>, loc_ori : &mut Vec<DiffDoub0>, glob_disp : &mut Vec<DiffDoub0>, stat : usize) {
        ...
        let mut i_ori_size : usize =  (self.num_nds+1)*144;
    ...
    pub fn get_stress_prereq_dfd0(& self, pre : &mut DiffDoub0StressPrereq, sec_ar : &mut Vec<Section>, mat_ar : &mut Vec<Material>, nd_ar : &mut Vec<Node>, dv_ar : & Vec<DesignVariable>) {
        ...
        if (self.dof_per_nd == 6) {
            ...
            if (self.this_type != 2) {
                ...
                self.get_shell_mass_dfd0(&mut pre.mmat, &mut  pre.layer_thk, &mut  pre.layer_z, &mut  pre.layer_den, sec_ar, dv_ar);
                self.get_shell_cond_dfd0(&mut pre.tcmat, &mut  pre.layer_thk, &mut  pre.layer_ang, &mut  pre.layer_tc, sec_ar, dv_ar);
    ...
    pub fn get_fluid_prereq_dfd0(&mut self, pre : &mut DiffDoub0FlPrereq, sec_ar : &mut Vec<Section>, fl_ar : &mut Vec<Fluid>, nd_ar : &mut Vec<Node>, dv_ar : & Vec<DesignVariable>) {
        ...
        let mut this_fl = &fl_ar[this_sec.fl_ptr];
        
        sec_prop = this_sec.ref_turb_e;
        pre.ref_turb_e.set_val(sec_prop);
        self.get_gen_prop_dfd0(&mut pre.ref_turb_e, &mut CppStr::from("refTurbE"), dv_ar);
        
        sec_prop = this_sec.grad_vturb_coef;
        pre.grad_vturb_coef.set_val(sec_prop);
        self.get_gen_prop_dfd0(&mut pre.ref_turb_e, &mut CppStr::from("gradVTurbCoef"), dv_ar);
        
        sec_prop = this_sec.diss_turb_coef;
        pre.diss_turb_coef.set_val(sec_prop);
        self.get_gen_prop_dfd0(&mut pre.ref_turb_e, &mut CppStr::from("dissTurbCoef"), dv_ar);
        ...
        self.get_gen_prop_dfd0(&mut pre.den_vis_coef, &mut CppStr::from("denVisCoef"), dv_ar);
        ...
        self.get_gen_prop_dfd0(&mut pre.den_enth_coef, &mut CppStr::from("denEnthCoef"), dv_ar);
        
        sec_prop = this_sec.enth_exp;
        pre.den_enth_exp.set_val(sec_prop);
        self.get_gen_prop_dfd0(&mut pre.den_enth_exp, &mut CppStr::from("denEnthExp"), dv_ar);
        
        sec_prop = this_sec.pres_coef;
        pre.den_pres_coef.set_val(sec_prop);
        self.get_gen_prop_dfd0(&mut pre.den_pres_coef, &mut CppStr::from("denPresCoef"), dv_ar);
        
        sec_prop = this_sec.pres_exp;
        pre.den_pres_exp.set_val(sec_prop);
        self.get_gen_prop_dfd0(&mut pre.den_pres_exp, &mut CppStr::from("denPresExp"), dv_ar);
    ...
    pub fn d_stress_straind_u_dfd0(&mut self, dsd_u : &mut Vec<DiffDoub0>, ded_u : &mut Vec<DiffDoub0>, dsd_t : &mut Vec<DiffDoub0>, spt : &mut [f64], layer : usize, n_lgeom : bool, pre : &mut DiffDoub0StressPrereq) {
        ...
        let mut tot_dof : usize =  self.num_nds * self.dof_per_nd + self.num_int_dof;
        i2 = 6 * tot_dof;
        for i1 in 0..i2 {
    ...
    pub fn put_vec_to_glob_mat_dfd0(&mut self, q_mat : &mut SparseMat, el_qvec : &mut Vec<DiffDoub0>, for_therm : bool, mat_row : usize, nd_ar : &mut Vec<Node>) {
        ...
        let mut tot_dof : usize =  nd_dof + self.num_int_dof;
        let mut nd : usize;
        let mut dof : usize;
...
//DiffDoub1 versions: 
    ...
    pub fn get_stress_prereq_dfd1(& self, pre : &mut DiffDoub1StressPrereq, sec_ar : &mut Vec<Section>, mat_ar : &mut Vec<Material>, nd_ar : &mut Vec<Node>, dv_ar : & Vec<DesignVariable>) {
        ...
        if (self.dof_per_nd == 6) {
            ...
            if (self.this_type != 2) {
                ...
                self.get_shell_mass_dfd1(&mut pre.mmat, &mut  pre.layer_thk, &mut  pre.layer_z, &mut  pre.layer_den, sec_ar, dv_ar);
                self.get_shell_cond_dfd1(&mut pre.tcmat, &mut  pre.layer_thk, &mut  pre.layer_ang, &mut  pre.layer_tc, sec_ar, dv_ar);
    ...
    pub fn get_fluid_prereq_dfd1(&mut self, pre : &mut DiffDoub1FlPrereq, sec_ar : &mut Vec<Section>, fl_ar : &mut Vec<Fluid>, nd_ar : &mut Vec<Node>, dv_ar : & Vec<DesignVariable>) {
        ...
        sec_prop = this_sec.ref_turb_e;
        pre.ref_turb_e.set_val(sec_prop);
        self.get_gen_prop_dfd1(&mut pre.ref_turb_e, &mut CppStr::from("refTurbE"), dv_ar);
        
        sec_prop = this_sec.grad_vturb_coef;
        pre.grad_vturb_coef.set_val(sec_prop);
        self.get_gen_prop_dfd1(&mut pre.ref_turb_e, &mut CppStr::from("gradVTurbCoef"), dv_ar);
        
        sec_prop = this_sec.diss_turb_coef;
        pre.diss_turb_coef.set_val(sec_prop);
        self.get_gen_prop_dfd1(&mut pre.ref_turb_e, &mut CppStr::from("dissTurbCoef"), dv_ar);
        ...
        sec_prop = this_sec.den_vis_coef;
        pre.den_vis_coef.set_val(sec_prop);
        self.get_gen_prop_dfd1(&mut pre.den_vis_coef, &mut CppStr::from("denVisCoef"), dv_ar);
        ...
        sec_prop = this_sec.enth_coef;
        pre.den_enth_coef.set_val(sec_prop);
        self.get_gen_prop_dfd1(&mut pre.den_enth_coef, &mut CppStr::from("denEnthCoef"), dv_ar);
        
        sec_prop = this_sec.enth_exp;
        pre.den_enth_exp.set_val(sec_prop);
        self.get_gen_prop_dfd1(&mut pre.den_enth_exp, &mut CppStr::from("denEnthExp"), dv_ar);
        
        sec_prop = this_sec.pres_coef;
        pre.den_pres_coef.set_val(sec_prop);
        self.get_gen_prop_dfd1(&mut pre.den_pres_coef, &mut CppStr::from("denPresCoef"), dv_ar);
        
        sec_prop = this_sec.pres_exp;
        pre.den_pres_exp.set_val(sec_prop);
        self.get_gen_prop_dfd1(&mut pre.den_pres_exp, &mut CppStr::from("denPresExp"), dv_ar);
