...
pub struct JobCommand {
    ...
    pub enforce_max_c : bool,
    pub save_soln_hist : bool,
    pub soln_hist_freq : usize,
    pub sim_period : f64,
    pub lump_mass : bool,
    ...
    pub dissipation : f64,
    pub mod_turb : bool,
    pub fluid_solver : CppStr,
    pub fluid_block_dim : usize,
    pub max_fsi_gap : f64,
    pub run_user_update : bool,
...
impl JobCommand {
    pub fn new() -> JobCommand {
        JobCommand {
            ...
            const_scale_factor : -1.0,
            enforce_max_c : false,
            save_soln_hist : true,
            soln_hist_freq : 1usize,
            sim_period : 1f64,
            lump_mass : false,
            ...
            dissipation : 0.25,
            mod_turb : true,
            fluid_solver : CppStr::from("iterative"),
            fluid_block_dim : 20,
            max_fsi_gap : -1f64,
