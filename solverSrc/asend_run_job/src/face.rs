...
pub struct CentData {
    ...
    pub f_dfd0 : [DiffDoub0; 3],
    pub f_dfd1 : [DiffDoub1; 3],
    pub hg_dfd0 : DiffDoub0,
    pub hg_dfd1 : DiffDoub1,
}
...
impl CentData {
    pub fn new() -> CentData {
        CentData {
            ...
            f_dfd0 : [DiffDoub0::new(); 3],
            f_dfd1 : [DiffDoub1::new(); 3],
            hg_dfd0 : DiffDoub0::new(),
            hg_dfd1 : DiffDoub1::new(),
        }
    }
}